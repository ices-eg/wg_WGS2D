...
forecast.dat <- subset(all.ss,type=="NMME" & year(date)==2019 & sp.subdomain==sel.sp & name != "NMME-ensmean")
forecast.ensmean <- subset(all.ss,type=="NMME" & year(date)==2019 & sp.subdomain==sel.sp & name == "NMME-ensmean")
...
ggplot(mapping=aes(x=lead,y=cor,group=name))+
  ...
  labs(x="Lead time (months)",y="Correlation coefficient (r)",colour="")
