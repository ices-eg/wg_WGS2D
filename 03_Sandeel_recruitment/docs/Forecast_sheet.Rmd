...
ggplot(forecast.plt)+
  ...
  geom_text(aes(x=lbl,y= ifelse(prob.lbl == 5, prob.lbl+35, prob.lbl+15), 
                      label=ifelse(prob.lbl == 5, paste0("Less than ", prob.lbl, "%"), paste0(prob.lbl, "%"))))+
